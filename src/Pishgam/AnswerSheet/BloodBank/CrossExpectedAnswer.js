...
const CrossExpectedAnswer = () => {
    ...
    return (
        <Card>
            <ThemeCardHeader title='جواب مورد انتظار Crossmatch'></ThemeCardHeader>
            <CardBody>
                ...
                <Crosstest values={values} Crossmatch={interpretation} onChange={onChange} data={data} />
            </CardBody>
            <CardFooter>
...
export default CrossExpectedAnswer;